/**
 * @keenmate/svelte-wysiwyg-v5 - TypeScript Definitions
 *
 * Svelte 5 wrapper for Jodit WYSIWYG Editor with full TypeScript support.
 */
...
declare const WysiwygEditor: Component<WysiwygEditorProps>;
